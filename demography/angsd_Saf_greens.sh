...
population="greens"
bamlist= $WORKDIR/greens_bam.list
jobToDo="-nThreads 24 -GL 1 -doSaf 1 -doCounts 1 -ref $REF -anc $REF"
filters="-minInd 16 -minMapQ 20 -minQ 20 -setMinDepthInd 1 -setMaxDepthInd 50 -remove_bads 1 -C 50 -baq 1 -uniqueOnly 1 -only_proper_pairs 1"
...
#	-> Total number of sites analyzed: 475628169
#	-> Number of sites retained after filtering: 7006222 

$HOME/Software/ANGSD/angsd/misc/realSFS greens.saf.idx -P 24 -fold 1 > greens_nonCDS_SFS.txt
