...
#	-> Total number of sites analyzed: 312492601
#	-> Number of sites retained after filtering: 10445028 

$HOME/Software/ANGSD/angsd/misc/realSFS PAL.saf.idx -P 24 -fold 1 > PAL_nonCDS_SFS.txt
